function schimba_pagina() {
  ...
  document.getElementById("poza").src = "tudor-2.jpeg";
...
window.onload = ruleaza;
function ruleaza() {
  x = 0;
  setInterval(function () {
    if (x == 1) {
      document.getElementById("poza-de-schimbat").src = "poza.jpeg";
      document.getElementById("nume-poza").innerHTML = "Neagu Annelisse";
      document.getElementById("hyperlink-nume").href = "annelisse.html";
    }
    else if(x==0){
      document.getElementById("poza-de-schimbat").src = "tudor.jpeg";
      document.getElementById("nume-poza").innerHTML = "Muresan Tudor Horea";
      document.getElementById("hyperlink-nume").href = "tudor.html";
    }
    x++;
    if(x==2)x=0;
  },3000);
